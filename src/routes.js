...
const Clientes = React.lazy(() => import('./views/theme/colors/Colors'))
...
const routes = [
  ...
  { path: '/theme', name: 'Theme', component: Clientes, exact: true },
  { path: '/empleados', name: 'Clientes', component: Clientes },
